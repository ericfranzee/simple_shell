 ...
 * @estr: a string holding the error type selected.
 * Return: 0 if no numbers in string, converted number otherwise
 *        -1 on error
 */
...
/**
 * print_d - function that generates a decimal (integer) number (base 10)
 * @input: the input
 * @fd: the filedescriptor to which you want to write
...
/**
 * remove_comments - function that substitutes
 * the first occurrence of '#' with '0'
